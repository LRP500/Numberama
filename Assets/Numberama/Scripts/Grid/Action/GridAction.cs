...
namespace Numberama.Grid.Action
{
    public class GridAction : MonoBehaviour, IPointerDownHandler
    {
        ...
        private global::System.Action OnExecuteFail = null;
        ...
        public void RegisterOnExecute(GridActionCallback success, global::System.Action fail)
        {
