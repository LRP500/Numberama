...
using Numberama.Tools.Persistence;
...
namespace Numberama.Grid
{
    public sealed class GridCell : MonoBehaviour, IPointerDownHandler, IPersistable
    {
        ...
        private global::System.Action<GridCell> _callback = null;
        ...
        public void SetCallback(global::System.Action<GridCell> callback)
        {
            _callback = callback;
        }
